    ...
    return (
      ...
      <Navbar style={{ backgroundColor: '#FFF' }} light expand="md">
          ...
          <p style={{ marginTop: 8, marginLeft: 20, fontFamily: 'Montserrat' }}>Hi</p>
              ...
              {accessToken && <UncontrolledDropdown id="btnLogout" nav inNavbar>
            ...
            <Nav id="menuCartLink" className="ml-auto" navbar>
              <NavItem style={{ marginRight: 20 }}>
                <NavLink onClick={() => history.push('/cart')} style={{ display: 'flex', cursor: 'pointer' }}>
                  <i className="fas fa-shopping-bag" style={{
                    ...
                    <p id="menuCartQuantity" style={{ marginTop: 0, fontSize: 14, fontFamily: 'Montserrat' }}>{productIncart.length}</p>
                    </div>
                </NavLink>
              </NavItem>
              <NavItem>
              ...
              <NavItem>
                <NavLink id="menuCartTotalPrice" style={{ fontFamily: 'Montserrat', cursor: 'pointer' }} onClick={() => history.push('/cart')}>$ {cartPrice ? cartPrice : '0.00'} </NavLink>
              </NavItem>
            </Nav>
          </Collapse>
        </Navbar>
